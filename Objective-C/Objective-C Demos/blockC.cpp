...
static struct __outside_block_desc_0 {
  size_t reserved;
  size_t Block_size;
} __outside_block_desc_0_DATA = { 0, sizeof(struct __outside_block_impl_0)};
static __outside_block_impl_0 __global_outside_block_impl_0((void *)__outside_block_func_0, &__outside_block_desc_0_DATA);
void (*outside)(void) = ((void (*)())&__global_outside_block_impl_0);
